...
모든 기술 명세 및 상세 문서는 `specs/` 폴더 내에 위치하며, 프로젝트 개요는 루트의 `README.md`에서 관리합니다.
...
* **`specs/ARCHITECTURE.md`**: 기술 스택, 폴더 구조, 설계 원칙에 대한 상세 명세.
* **`specs/RULES.md`**: 코딩 컨벤션, 폴더 구조 및 프로젝트 규칙.
* **`specs/TODO.md`**: 현재 진행형인 작업 및 단기 목표.
* **`specs/DOCUMENTATION.md`**: (본 문서) 문서화 규칙 및 관리 가이드.
